...
output "bastion_public_ip" {
  description = "Bastion host public IP (SSH: ssh -i key.pem ec2-user@<ip>)"
...
# ─── RDS ──────────────────────────────────────────────────────────────────────
output "rds_ror_endpoint" {
  description = "RDS endpoint for Rails app"
  value       = aws_db_instance.vishnu_terraform_rds_ror.endpoint
}
